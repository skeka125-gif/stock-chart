...
const STOCKS = [
  ...
  },
  {
    ...
    data: [
      {w:28,eval:22.02,avg:61.92,cur:65.01},{w:29,eval:41.32,avg:64.91,cur:76.71},{w:30,eval:65.14,avg:69.44,cur:71.88},{w:31,eval:67.51,avg:69.08,cur:60.63},{w:32,eval:97.94,avg:67.51,cur:63.04}
    ]
  },
  {
    name: "마이크론", ticker: "MU", color: "#06B6D4", startWeek: 29, firstPrice: 1074.00,
    data: [
      {w:29,eval:15.13,avg:1047.97,cur:1133.99},{w:30,eval:42.64,avg:1114.19,cur:1132.33},{w:31,eval:49.55,avg:1101.47,cur:975.56},{w:32,eval:77.58,avg:1059.26,cur:979.30}
    ]
  },
  {
...
const WEEK_FX = {
  ...
  19:1450, 20:1476, 21:1484, 22:1479, 23:1467, 24:1501, 25:1520, 26:1510, 27:1560, 28:1521, 29:1530, 30:1539, 31:1532, 32:1505
};

// 코스피/코스닥 지수 데이터
const INDEX_DATA = {
  KOSPI: [{w:27,cur:8160.59},{w:28,cur:8123.62},{w:29,cur:9052.42},{w:30,cur:8411.21},{w:31,cur:8088.34},{w:32,cur:7475.94}],
  KOSDAQ: [{w:27,cur:1002.44},{w:28,cur:1029.05},{w:29,cur:966.59},{w:30,cur:851.37},{w:31,cur:868.41},{w:32,cur:837.43}],
};
...
const WEEK_DATES = {
  ...
  17:"3/29", 18:"4/05", 19:"4/11", 20:"4/18", 21:"4/26", 22:"5/03", 23:"5/09", 24:"5/16", 25:"5/23", 26:"5/30", 27:"6/06", 28:"6/13", 29:"6/20", 30:"6/27", 31:"7/04", 32:"7/11"
};
...
const PORTFOLIO_KRW = [
  ...
  4581646, 4743190, 5235202, 5967135, 6694364, 7308111, 7630152, 8499491, 8774317, 9223807, 9634053, 9487725, 9763976, 10278343, 10136012, 10421745, 10942817
];
...
const SAVINGS_KRW = [
  ...
  4801787, 5058240, 5371197, 5718468, 6062436, 6357127, 6609537, 6836000, 7224341, 7564621, 7799124, 8176899, 8277138, 8514310, 8922857, 9091574, 9335510
];
